...
| **Idade** | 24 anos | 41 anos |
| **Ocupação** | Trabalho esporádico como "vidente" | Assistente noturno de biblioteca universitária há 14 anos |
| **Cenário da consulta** | Leito de obstetrícia, interconsulta psiquiátrica pós-parto | Ambulatório de saúde mental, primeira consulta, encaminhamento da clínica geral |
| **Trigger da avaliação** | Suspeita da equipe obstétrica de "esquizofrenia"; gravidez resultante de estupro | Irmã preocupada após entrar no apartamento e ver organização incomum |
| **Conteúdo das crenças** | Astrologia, projeção astral, reencarnação | Padrões matemáticos (Fibonacci, primos), "frequências" das pessoas e dos lugares, premonição de doenças |
| **Apresentação física** | Camisolas hospitalares sobrepostas, manto ao avesso, cabelo trançado pela metade | Camadas de roupa civil em combinações incomuns, anel grande, caderno na pasta |
| **Trajetória reprodutiva / sexual** | Estupro recente, gravidez, plano de adoção | Não abordado; um único namoro breve há ~20 anos |
| **Funcionamento familiar** | Família achava as crenças estranhas | Pais falecidos; irmã única cuidadora |
| **Sequência narrativa** | Original apresenta o caso em terceira pessoa, com foco no exame do estado mental e na cena hospitalar | Novo roteiro é entrevista ambulatorial dialogada, sem replicar a ordem do texto-fonte |
| **Linguagem** | Texto expositivo com aspas pontuais | Diálogo natural; nenhuma frase literal reaproveitada |

Mudanças adicionais:

- Eliminação completa do contexto obstétrico, do trauma sexual e da gravidez.
- Substituição do conteúdo místico-religioso (astrologia, reencarnação) por **conteúdo mágico-matemático** funcionalmente equivalente (sequências numéricas, "frequências").
- Substituição da cena visual marcante (paciente em camisolas sobrepostas com manto ao avesso) por uma apresentação ambulatorial cotidiana, sem componente bizarro hospitalar.
- Substituição do "trabalho esporádico como vidente" por **emprego formal estável em nicho protegido e solitário** — preservando o princípio clínico (funcionamento ocupacional limitado a contextos com baixa demanda interpessoal) sem repetir a cena.
...
Não. As citações entre aspas do original ("escrito nas estrelas", "vidente com bola de cristal") **não** foram reaproveitadas em nenhuma forma. O vocabulário do novo roteiro é independente.

**2. Há alguma cena que preserva excessivamente a estrutura do caso original?**
A única zona de proximidade temática é a **descrição de crenças incomuns** e a **apresentação visual atípica do paciente** — ambas inevitáveis dada a fidelidade ao quadro clínico. A cena do original (hospitalar, pós-parto, com vestuário improvisado de hospital) **não foi reproduzida**; substituída por consulta ambulatorial com vestuário civil.

**3. A combinação de detalhes ainda torna o caso reconhecível?**
Não. Gênero, idade, ocupação, cenário, motivo da avaliação, conteúdo das crenças e estrutura familiar foram alterados em conjunto.

**4. O caso foi transformado de maneira substancial?**
Sim. Tema central, contexto clínico, perfil sociodemográfico, conteúdo das crenças e gênero textual (exposição → diálogo) foram modificados.

**5. Algum trecho deveria ser reescrito para maior segurança?**
Não. A revisão crítica não identificou trechos que exijam reescrita adicional.

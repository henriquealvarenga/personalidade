...
| **Idade** | 42 anos | 26 anos |
| **Ocupação** | Não detalhada | Professora de dança, instrutora particular, mestre de cerimônias em casamentos |
| **Cenário da consulta** | Procura uma psiquiatra dizendo que a vida "está se desmantelando" | Procura ambulatório por conta própria após "crise" em festa de aniversário |
| **Trigger** | Término de relacionamento de dois meses; insônia por lamentar a perda | Encontro inesperado com ex em festa pública; saída em prantos da pista de dança |
| **Tempo do "grande amor"** | Cinco encontros, dois meses | Seis encontros, dois meses e meio (intervalo aproximado, contexto distinto) |
| **Aparência/sinais** | Camisa tropical, calça cáqui, soluços curtos e sorrisos amplos, toques no braço da entrevistadora | Maquiagem cuidada e acessórios chamativos; mão no peito; lágrima breve e recuperação rápida; toque no ombro no encerramento (opcional) |
| **Vínculos prévios** | Não detalhados | Três "grandes amores" nomeados (Leonardo, Rodrigo, Caio), com padrão recorrente; muitas amigas, mais investidas em romances |
| **Sequência narrativa** | Original abre com choro pelo término, descreve a aparência, narra a entrevista em terceira pessoa | Novo roteiro abre com narrativa cinematográfica da crise da festa; segue para descrição vaga do ex, vínculos repetidos, vida ocupacional e longitudinal |
| **Frases marcantes do original** | "no abismo do desespero", "nas nuvens", "amor da minha vida, simplesmente linda, linda" | **Nenhuma** reaproveitada |

Mudanças adicionais:

- Inversão de gênero, redução de idade em 16 anos, criação de ocupação que **encena** o traço (palco, festa, performance) sem replicar o caso.
- Substituição da cena específica do consultório com soluços e toques no braço da entrevistadora pela **cena da festa**, narrada em primeira pessoa.
- Substituição do par "abismo–nuvens" por construção própria ("tô amando a vida"/"minha vida acabou").
- Inclusão de cenas inéditas (encontro em rooftop, mãe descrevendo performances aos três anos, contrato perdido por crise amorosa).
...
Não. As citações marcantes do texto-fonte ("amor da minha vida, simplesmente linda, linda", "abismo do desespero", "nas nuvens") **não** foram reaproveitadas.

**2. Há alguma cena que preserva excessivamente a estrutura do caso original?**
A zona temática inevitável é a **descrição idealizada e vaga do parceiro recente**, núcleo do diagnóstico. A formulação foi construída de modo independente, com vocabulário e estrutura próprios.

**3. A combinação de detalhes ainda torna o caso reconhecível?**
Não. Gênero, idade, ocupação, cenário do desencadeante e estrutura interpessoal foram alterados em conjunto.

**4. O caso foi transformado de maneira substancial?**
Sim. Personagem, contexto, vínculos, queixa e gênero textual foram modificados.

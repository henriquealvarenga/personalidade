...
| **Cenário da consulta** | Internação em unidade psiquiátrica | Ambulatório de seguimento pós-emergência clínica, **sem internação psiquiátrica neste episódio** |
| **Trigger** | Terapeuta saiu de férias por uma semana | Namorado pediu "um tempo" por mensagem |
| **Método autolesivo no episódio** | Cortes em ambos os punhos, superficiais, sem necessidade de sutura | Intoxicação aguda por paracetamol em alta dose, com observação clínica de 48 h |
| **Cena marcante intra-hospitalar** | Conflito entre médico residente (que defende alta) e equipe de enfermagem (que aponta quebra de regras), recurso ao diretor da unidade | **Eliminada**: o roteiro se passa em ambulatório, sem cena de equipe. A cisão é encenada **dentro da consulta** (idealização → desvalorização do próprio entrevistador). |
| **Fenômeno perceptivo descrito** | Relato de voz que negava em seguida | **Eliminado**: substituído por **vivência de não saber "quem é"**, mais central à identidade borderline e menos confundível com psicose |
| **Histórico de internações** | Quarta internação, todas por afastamento de alguém | Duas internações breves prévias, padrão semelhante, mas com **episódio atual ambulatorial** |
| **Frases marcantes do original** | "abandoná-la", "apenas algumas horas", "ela nunca seria nada" | **Nenhuma** reaproveitada |
| **Vínculos** | Centrado no terapeuta como gatilho | Namorado atual; histórico de parceiros de ambos os gêneros; mãe; amiga; terapeuta passada referida como precedente |
| **Sequência narrativa** | Original abre na enfermaria com corte recente e segue para conflito de equipe | Novo roteiro abre em ambulatório, com seguimento pós-overdose, segue para padrão relacional, ocupacional, longitudinal, com cena final de **estabelecimento de combinado de segurança** |

Mudanças adicionais:

- Inversão de gênero, mudança de geração, mudança de cenário institucional (internação → ambulatório).
- Substituição do **terapeuta como gatilho** por **parceiro afetivo como gatilho**, com referência secundária a uma terapeuta anterior — preservando o princípio clínico do abandono.
- Eliminação da cena emblemática **do conflito de equipe na enfermaria**; substituída pelo fenômeno equivalente da **cisão observada na própria entrevista**.
- Eliminação do **microssintoma psicótico** (voz negada) por elementos de **distúrbio de identidade**, mais discriminantes para o diagnóstico.
- Cenas inéditas: combinado de contingência antes de qualquer ato; mostrar cicatrizes em manga comprida; referência à overdose como mensagem para o parceiro.
...
Não. As citações marcantes do original ("ela nunca seria nada", "abandoná-la", "apenas algumas horas") **não** foram reaproveitadas.

**2. Há alguma cena que preserva excessivamente a estrutura do caso original?**
A zona temática inevitável é o **ato autolesivo desencadeado por afastamento percebido**. A formulação é narrativamente nova: outro método (paracetamol vs. corte), outro cenário (ambulatório pós-PS vs. enfermaria), outro gatilho (parceiro vs. terapeuta). A **cena do conflito de equipe**, talvez a mais reconhecível do original, foi removida; em seu lugar, a cisão é encenada **dentro da própria consulta**.

**3. A combinação de detalhes ainda torna o caso reconhecível?**
Não. Gênero, idade, cenário, método autolesivo, gatilho e ambiente institucional foram alterados em conjunto.

**4. O caso foi transformado de maneira substancial?**
Sim. Personagem, cenário, gatilho, método, vínculos e gênero textual foram modificados.

...
::: {.callout-warning appearance="simple"}
## [ESCREVER — análise]
**Conexão com o apêndice**: o capítulo do livro sobre *A descoberta às avessas* já apresenta os heterônimos (Caeiro, Reis, Campos, Soares) e o "dia triunfal" de 8 de março de 1914 [@pessoa_carta_casais_monteiro_1935]. Aqui o argumento é outro: Pessoa não construiu personagens — ele **autorizou autores**.
